...
const serverEnvSchema = z.object({
  ...
  VOLCENGINE_ARK_ASSET_ACCESS_KEY: z.string().min(1).optional(),
  VOLCENGINE_ARK_ASSET_SECRET_KEY: z.string().min(1).optional(),
  VOLCENGINE_ARK_ASSET_PROJECT_NAME: z.string().min(1).optional(),
  VOLCENGINE_ARK_ASSET_BASE_URL: z.url().optional(),
  VOLCENGINE_ARK_BASE_URL: z.url().optional(),
  VOLCENGINE_ARK_IMAGE_MODEL: z.string().min(1).optional(),
  VOLCENGINE_ARK_VIDEO_MODEL: z.string().min(1).optional(),
...
const parsedServerEnv = serverEnvSchema.parse({
  ...
  VOLCENGINE_ARK_ASSET_ACCESS_KEY: process.env.VOLCENGINE_ARK_ASSET_ACCESS_KEY,
  VOLCENGINE_ARK_ASSET_SECRET_KEY: process.env.VOLCENGINE_ARK_ASSET_SECRET_KEY,
  VOLCENGINE_ARK_ASSET_PROJECT_NAME: process.env.VOLCENGINE_ARK_ASSET_PROJECT_NAME,
  VOLCENGINE_ARK_ASSET_BASE_URL: process.env.VOLCENGINE_ARK_ASSET_BASE_URL,
  VOLCENGINE_ARK_BASE_URL: process.env.VOLCENGINE_ARK_BASE_URL,
  VOLCENGINE_ARK_IMAGE_MODEL: process.env.VOLCENGINE_ARK_IMAGE_MODEL,
